...
function Product(props){
    ...
    const insertshopcart =() =>{
        ...
        // check quantity
        {if(quantitys === '' || quantitys === '0' || quantitys > 10){
        ...
        products.listsize.filter((pro)=>{
            if(pro.id = productdetailid){
                inventory = pro.inventory
                if( (pro.inventory - quantitys) >= 0){
                    proactive = pro;
                    return proactive
                }
            }
                                ...
                                <div className="product-details product-details-centered">
                                    ...
                                    <div className="product-details-footer">
                                        <div className="product-cat">
                                            <span>Category:</span>
                                            <Link to={{pathname: `/category/${products.categoryid}`}} >{products.categoryname}</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
