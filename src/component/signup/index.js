...
function Signup(){
    ...
    const linkgg = 'https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=https://api-shoes.herokuapp.com/api/auth/login-google&response_type=code&client_id=721465338797-4lcqo4qql4vmevh90pnaahvo6tem4lsr.apps.googleusercontent.com&approval_prompt=force';
    const linkfb = 'https://www.facebook.com/dialog/oauth?client_id=1101972766995519&redirect_uri=https://api-shoes.herokuapp.com/api/auth/login-facebook';   
   ...
   const signupAccount = () =>{
    ...
    if(usernames.length <3 ||  passwords.length <4 ||  firstnames.length <3 ||  lastnames.length <3 ||
         phones.length !==10|| addresss.length < 5 ){
